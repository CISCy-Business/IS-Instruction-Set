...
{
    public class ClearOverflowFlag : R2NoOperands
    {
        public const string Mnemonic = "CLO";

        public const ushort OpCode = 0b0000_0110_0100_0000;

        public override ControlBits controlBits => new(false, false, false, false, false, false, false);

        public override AluOperation? aluOperation => AluOperation.ClearOverflowFlag;
