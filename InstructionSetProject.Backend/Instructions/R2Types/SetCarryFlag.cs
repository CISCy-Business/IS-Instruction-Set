...
{
    public class SetCarryFlag : R2NoOperands
    {
        public const string Mnemonic = "STC";

        public const ushort OpCode = 0b0000_0110_1000_0000;

        public override ControlBits controlBits => new(false, false, false, false, false, false, false);

        public override AluOperation? aluOperation => AluOperation.SetCarryFlag;
